...
- 👉 [Soft UI Dashboard Django](https://flask-soft-ui-dashboard.appseed-srv1.com/) - LIVE Demo
...
- Timestamp: `2022-06-11 05:30`
- Build ID: `7704df5a-f13c-49c5-bad6-ef2be6391db3`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7704df5a-f13c-49c5-bad6-ef2be6391db3.git
$ cd 7704df5a-f13c-49c5-bad6-ef2be6391db3
```
